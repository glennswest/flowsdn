...
impl Definition {
    ...
    pub fn default_provenance(self) -> Option<&'static str> {
        ...
        Some(match self.name {
            ...
            "bpf-lb-maglev-hash-seed" => "docs/spec/05-service-loadbalancing.md:932",
            ...
            "hubble-drop-events-reasons" => "docs/spec/11-hubble-monitor.md:2540",
            "hubble-event-buffer-capacity" => "docs/spec/11-hubble-monitor.md:2491",
            "hubble-lost-event-send-interval" => "docs/spec/11-hubble-monitor.md:2494",
            "hubble-socket-path" => "docs/spec/11-hubble-monitor.md:2489",
            "hubble-tls-cert-file" => "docs/spec/11-hubble-monitor.md:2497",
            "hubble-tls-client-ca-files" => "docs/spec/11-hubble-monitor.md:2499",
            "hubble-tls-key-file" => "docs/spec/11-hubble-monitor.md:2498",
