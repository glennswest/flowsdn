...
impl Definition {
    ...
    pub fn default_provenance(self) -> Option<&'static str> {
        ...
        Some(match self.name {
            ...
            "bpf-lb-dsr-dispatch" => "docs/spec/05-service-loadbalancing.md:936",
            "bpf-lb-maglev-hash-seed" => "docs/spec/05-service-loadbalancing.md:940",
            "bpf-lb-maglev-table-size" => "docs/spec/05-service-loadbalancing.md:939",
            "bpf-lb-map-max" => "docs/spec/05-service-loadbalancing.md:928",
            "bpf-lb-mode" => "docs/spec/05-service-loadbalancing.md:934",
            ...
            "enable-dynamic-source-lookup-nodeport" => "docs/spec/05-service-loadbalancing.md:951",
            ...
            "node-port-range" => "docs/spec/05-service-loadbalancing.md:930",
