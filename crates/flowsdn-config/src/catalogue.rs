...
impl Definition {
    ...
    pub fn default_provenance(self) -> Option<&'static str> {
        ...
        Some(match self.name {
            ...
            "hubble-lost-event-send-interval" => "docs/spec/11-hubble-monitor.md:2479",
            "hubble-socket-path" => "docs/spec/11-hubble-monitor.md:2474",
            "hubble-tls-cert-file" => "docs/spec/11-hubble-monitor.md:2482",
            "hubble-tls-client-ca-files" => "docs/spec/11-hubble-monitor.md:2484",
            "hubble-tls-key-file" => "docs/spec/11-hubble-monitor.md:2483",
