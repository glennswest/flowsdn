...
| `bpf-map-event-buffers` | `(empty)` | [spec 03, line 924](../../docs/spec/03-identity-ipcache.md#L924) |
...
| `fixed-identity-mapping` | `(empty)` | [spec 03, line 909](../../docs/spec/03-identity-ipcache.md#L909) |
